...
const createPageUrl = (basePath: string, params: string, page: number) => {
    ...
    return (
        <div className="flex justify-center mt-10 mb-20 text-white text-sm md: text-base">
            <nav className="flex gap-1 md: gap-2 items-center">
                <Link
                    href={createPageUrl(basePath, params.toString(), 1)}
                ...
                <Link
                    href={createPageUrl(basePath, params.toString(), currentPage - 1)}
                    aria-disabled={currentPage === 1}
                    tabIndex={currentPage === 1 ? -1 : undefined}
                    className={`${buttonSize} ${
                        currentPage === 1 ? buttonDisabled : buttonActive
                ...
                ...
                    ...
                    return (
                        <Link
                            key={page}
                            href={createPageUrl(basePath, params.toString(), page as number)}
                ...
                <Link
                    href={createPageUrl(basePath, params.toString(), totalPages)}
                    aria-disabled={currentPage === totalPages}
                    tabIndex={currentPage === totalPages ? -1 : undefined}
                    className={`${buttonSize} ${
                        currentPage === totalPages ? buttonDisabled : buttonActive
